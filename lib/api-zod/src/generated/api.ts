...
export const GetSiteSettingsResponse = zod.object({
  ...
  "hero_video_url": zod.string().optional().describe('Hero background video URL from Supabase (MP4\/WebM)'),
  ...
  "features_video_url": zod.string().optional().describe('Features section video URL from Supabase (MP4\/WebM)'),
  ...
  "immersion_video_url": zod.string().optional().describe('Immersion section video URL from Supabase (MP4\/WebM)'),
